...
public class Constraints {
    ...
    //Trump.Peter relatives valid datas
    public static final String FIRST_NAME = "Tom";
    public static final String LAST_NAME = "Deyes";
    public static final String BIRTH_DATE = "01-01-1991";
    public static final String PHONE_NUMBER = "+36301234567";
    public static final String FIRST_NAME_EMPTY = "";
    public static final String LAST_NAME_EMPTY = "";
    public static final String BIRTH_DATE_EMPTY = "";
